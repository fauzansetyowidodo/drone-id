...
?>
 psfw-product-outer-wrapper-<?php echo esc_attr($random_num); ?> <?php echo esc_attr($content_align_class);?>  psfw-main-product-wrapper <?php echo esc_attr( $psfw_layout_class ); ?> <?php
    if ( (isset( $psfw_option[ 'psfw_show_button_one' ] ) && $psfw_option[ 'psfw_show_button_one' ] == '1') && $psfw_option[ 'psfw_show_button_one' ] != '1' ) {
        echo 'psfw-only-one-button';
    }
    if ( (isset( $psfw_option[ 'psfw_show_button_two' ] ) && $psfw_option[ 'psfw_show_button_two' ] == '1') && $psfw_option[ 'psfw_show_button_two' ] != '1' ) {
        echo 'psfw-only-one-button';
    }
    echo $image_hover;
    ?>" data-id="psfw_<?php
